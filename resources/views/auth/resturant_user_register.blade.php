...
<div class="register-box">
  ...
  <div class="card">
    <div class="card-body register-card-body">
      <p class="login-box-msg">Register as resturant user</p>

      <form action="{{ url('/resturant-user/register') }}" method="POST">
      @csrf
        <div class="input-group mb-3">
          <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" 
          name="name" value="{{ old('name') }}" placeholder="{{ __('User Name') }}" required autocomplete="name" autofocus>
        ...
        <div class="input-group mb-3">
          <input id="resturant_name" type="text" class="form-control @error('resturant_name') is-invalid @enderror" 
          name="resturant_name" value="{{ old('resturant_name') }}" placeholder="{{ __('Resturant Name') }}" required autocomplete="resturant_name" autofocus>
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-user"></span>
            </div>
